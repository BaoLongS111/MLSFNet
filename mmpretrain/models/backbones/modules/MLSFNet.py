...
class AdaptiveFusion(nn.Module):
    """Channel-wise adaptive fusion used inside HFF."""
...
class GCR(BaseModule):
    """Gated Channel Refinement."""
...
class MHCLCore(BaseModule):
    """Core conv-space modeling stage: HFF followed by GCR."""
    ...
    def __init__(
        ...
        self.gcr = GCR(channels=channels, mixer_rank=mixer_rank)
...
class MHCLAdapter(BaseModule):
    """Token-space adapter with paper-aligned naming: HFF + GCR."""
